...
# for purported explanation of socket address values returned by dgram packet sockets:
#
...
s = socket.socket(socket.PF_PACKET, socket.SOCK_DGRAM, socket.htons(ETH_P_ALL))
